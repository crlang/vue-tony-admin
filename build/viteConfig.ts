...
import { createProxy } from './vite/utils/proxy'

function defineAppConfig(defineOptions: { overrides?: UserConfig } = {}) {
    ...
    const applicationConfig: UserConfig = {
      ...
      server: isBuild
        ...
        : {
            ...
            proxy: createProxy({ VITE_PROXY_API_URL, VITE_GLOB_API_URL }),
...
async function createDefineData(root: string) {
  try {
    ...
    console.error('createDefineData error', error)
    return {}
  }
}
