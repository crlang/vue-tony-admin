...
import type { BasicListProps, ColumnSorterResult, FetchParams } from '../typing'
...
export function useDataSource(
  ...
  async function fetch(opt?: FetchParams) {
    ...
    try {
      ...
      console.info('===BasicList fetch info===', resultItems)
      emit('fetch-success', {
      ...
      console.error('===BasicList fetch error===', error)
