...
export const toolbar = [
  ...
  'fontsizeselect lineheight bold italic underline strikethrough alignleft aligncenter alignright outdent indent  blockquote undo redo removeformat subscript superscript forecolor backcolor',
]

export const menubar = false // 'file edit insert view format table'
